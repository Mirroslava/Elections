...
namespace ElectionLand.Data.Seed
{
    public class ApplicationDbInitializer : IDisposable
    {
        private readonly AplicationContext _context;

        public ApplicationDbInitializer(AplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task SeedDataAsync()
        {
            ...
            if (!await _context.Watchers.AnyAsync())
            {
                await SeedAsync();
            }
        }
        ...
        private async Task SeedAsync()
        {
            ...
            await AddUserStatusesAsync();
            await AddStatusesAsync();
            await AddVirtualCantonsAsync();
            await AddVirtualDistrictsAsync();
            await AddElectionsAsync();
            await AddCandidatesAsync();
            await AddVoicesAsync();
            await AddWatchersAsync();
            await AddAppealsAsync();
            await AddComplaintsAsync();
            await AddUserRelationshipsAsync();
        ...
        private async Task AddUserRolesAsync()
        {
            await _context.UserToRoles.AddRangeAsync(
                new UserToRole
                {
                    Id = 1,
                    UserId = 1,
        ...
        private async Task AddUserStatusesAsync()
        {
            await _context.UserStatuses.AddRangeAsync(
                new UserStatus
                {
                    Id = 1,
                    Title = "Elector"
        ...
        {
            await _context.StatusToUsers.AddRangeAsync(
                new StatusToUser
                {
                    Id = 1,
                    UserId = 3,
        ...
        private async Task AddVirtualCantonsAsync()
        {
            await _context.VirtualCantons.AddRangeAsync(
                new VirtualCanton
                {
                    Id = 1,
                    Title = "PMP-32",
        ...
        private async Task AddVirtualDistrictsAsync()
        {
            await _context.VirtualDistricts.AddRangeAsync(
                new VirtualDistrict
                {
                    Id = 1,
                    Title = "LoKoMoTyV",
        ...
        private async Task AddElectionsAsync()
        {
            await _context.Elections.AddRangeAsync(
                new Election
                {
                    Id = 1,
                    Title = "Вибори2019",
        ...
        private async Task AddCandidatesAsync()
        {
            await _context.Candidates.AddRangeAsync(
                new Candidate
                {
                    Id = 1,
                    UserId = 16,
        ...
        private async Task AddVoicesAsync()
        {
            await _context.Voices.AddRangeAsync(
                new Voice
                {
                    Id = 1,
                    UserId = 3,
        ...
        private async Task AddWatchersAsync()
        {
            await _context.Watchers.AddRangeAsync
            (
                new Watcher
                {
                    Id = 1,
        ...
        private async Task AddAppealsAsync()
        {
            await _context.Appeals.AddRangeAsync
            (
                new Appeal
                {
                    Id = 1,
        ...
        private async Task AddComplaintsAsync()
        {
            await _context.Complaintses.AddRangeAsync
            (
                new Complaints
                {
                    Id = 1,
        ...
        private async Task AddUserRelationshipsAsync()
        {
            await _context.UsetToVirtualDistricts.AddRangeAsync(
